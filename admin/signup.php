...
<body>
    <div class="wrapper">
        ...
        <div class="text-center mt-4 mb-4 name">Hahalolo</div> 
        <form class="p-3 mt-3" action="process-signup.php" method = "post">
            <div class="form-field d-flex align-items-center"> 
                <span class="far fa-user"></span> <input type="text" name="txtName" id="txtName" placeholder="Username" require autofocus> 
            </div>
            <div class="form-field d-flex align-items-center"> 
                <span class="far fa-user"></span> <input type="email" name="txtUsername" id="username" placeholder="Email" require autofocus> 
            </div>
            <div class="form-field d-flex align-items-center"> 
                <span class="fas fa-key"></span> <input type="address"name="txtaddress" id="address" placeholder="address" require> 
            </div> 
            <div class="form-field d-flex align-items-center"> 
